class UserSerializer < ActiveModel::Serializer
  ...
  def user_simple_info
    ...
    {id: object.id, title: object.email, nickname: object.nickname, location_id: object.location_id}
  end

  def user_detail_info
    user_detail_scope = ActiveModel::Type::Boolean.new.cast(scope.dig(:params, :user_detail_info))
    {id: object.id, title: object.email, nickname: object.nickname, location_id: object.location_id, user_type: object.user_type} if user_detail_scope rescue nil
  end
